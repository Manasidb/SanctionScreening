...
public class TransactionService {
	...
	public void addTransactions()
	{
		...
		Transaction t4 = new Transaction("4", d, "Manasi", "1234", "stefan salvatore", "6789", 2346, "valid");
	...
	*/
	...
	public List<Transaction> screening()
	{
		...
		for(Transaction t :transactionRepo.findAll())
		{
			...
			{
				int limit1 = (int) (payee.length() * 0.8);
				int limit2 = (int) (payer.length() * 0.8);
